...
| tag | 对应快照 | 内容 |
|---|---|---|
| `2026.8.21` | 2026-08-21 | 初始完整版（含实验性 skill，19 个） |
| `2026.8.29` | 2026-08-29 | 收敛为核心 8 skills |
| `2026.9.3` | 2026-09-03 | 9 个核心 skills |
| `2026.9.4` | 2026-09-04 | 添加 README、LICENSE 与 .gitattributes（原 `v1.0.0`） |
| `2026.9.7` | 2026-09-07 | 当前版：9 核心 skills 全面更新，新增灵敏度分析章节模板与图表选型/风格规范 |

```
git checkout 2026.9.7   # 查看任意历史版本
```
